...
public class TokenAuthenticationService {
    ...
    public static Authentication getAuthentication(HttpServletRequest request) {
        ...
        if (token != null) {
            ...
            Korisnik userAccount = korisnikRepository.findByKorisnickoIme(user);
            Collection<GrantedAuthority> authorities = new ArrayList<GrantedAuthority>();
           /* if(userAccount != null) {
                authorities.add(new SimpleGrantedAuthority(korisnikServis.getKorisnikTypeByUserName(userAccount.getKorisnickoIme())));
            }*/
